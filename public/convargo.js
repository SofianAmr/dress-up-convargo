...
let CONVARGO = (() => {
  ...
  const getTrucker = () => {
    return {
      'name': document.querySelector('#trucker .name form-control').value,
      'pricePerKm': document.querySelector('#trucker .price-by-km form-control').value,
      'pricePerCubic': document.querySelector('#trucker .price-by-cubic form-control').value
    };
  };
